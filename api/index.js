// ============================================================
//  C2 BACKEND – MODERN STATUS PANEL + ALL ROUTES
...
<div class="card">
    ...
    <div class="endpoints">
        ...
        <div><span class="highlight">GET</span> /api/test — System Status</div>
    </div>
...
<div class="container">
    ...
    if (path === '/api/register' && req.method === 'POST') {
        ...
        // deviceId sent from frontend (persistent)
