...
//  Vercel Hobby Plan: only 1 Serverless Function used!
// ============================================================
...
module.exports = async (req, res) => {
    ...
    // ============================================================
    //  ROUTE: /api/test (GET) — health check
    // ============================================================
    if (path === '/api/test') {
        const status = {
...
<script>
    ...
    if (params.get('error') === '1') {
        ...
        const supabaseKeyDisplay = supabaseKey || '';
...
<body>
    ...
    <script>
        const SUPABASE_URL = "${supabaseUrlDisplay}";
        const SUPABASE_KEY = "${supabaseKeyDisplay}";
