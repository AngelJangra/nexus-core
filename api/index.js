// ============================================================
//  C2 BACKEND – with /api/health for status dot
//  Deploy on Vercel – single function handles everything
// ============================================================
...
<div class="card">
    ...
    // ============================================================
    //  HTML STATUS PANEL – /api/test (human‑friendly)
    // ============================================================
    if (path === '/api/test') {
        // ... (the full HTML from your previous version – keep it as is)
        // For brevity, I'll include the full HTML here in the final paste.
        // (But I'll include it in the actual answer below.)
        return res.send(`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>... (full HTML) ...</body>
    ...
    // ============================================================
    //  JSON HEALTH CHECK – /api/health (for frontend dot)
    // ============================================================
    if (path === '/api/health') {
        return res.json({
            status: 'ok',
